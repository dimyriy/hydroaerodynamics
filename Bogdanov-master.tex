...
\frame{\frametitle{Субстанциональная производная тензора скоростей деформации}\tiny{
 $$
...
\frame{\frametitle{Течение в тестовом циклоне}
\tiny{
  \begin{minipage}[t]{0.5\linewidth}
    \vspace{0.1\textwidth}
    \begin{table}[h]
...
\frame{\frametitle{Результаты верификации}
\vspace{0.1\textwidth}
  \begin{minipage}[t]{\0.45\linewidth}
    \begin{figure}
...
\section{Решение}
\frame{\frametitle{Граничные условия}\tiny{
...
\frame{\frametitle{SST без коррекции на кривизну}
